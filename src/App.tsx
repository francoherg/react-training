...
function App() {
  ...
  function MovieCard({ title, duration }: Movie) {
    return (
      <div className="bg-white text-black rounded-xl shadow-lg overflow-hidden w-64 flex-shrink-0">
        <img src="https://i1.sndcdn.com/artworks-w4PvArKB7h6hzLou-qNnn7g-t500x500.jpg" className="w-full h-40 object-cover" />
        <div className="p-4">
...
<button
  className="px-6 py-2 bg-red-600 hover:bg-red-700 text-white rounded-lg transition font-semibold flex items-center gap-2 select-none active:scale-95"
...
<section className="max-w-4xl mx-auto mt-10 p-6 bg-white rounded-xl shadow text-black">
  <h3 className="text-2xl font-semibold mb-4 border-b pb-2">HOY</h3>
  ...
  <div className="carousel-container overflow-hidden">
    <div className="carousel-track flex gap-4">
      ...
      <section className="max-w-xl mx-auto mt-10 p-6 bg-white rounded-xl shadow">
        <h3 className="text-2xl font-semibold mb-4 border-b pb-2">Proximamente</h3>
